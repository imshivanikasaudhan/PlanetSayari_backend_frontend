@section('title', 'The Secure Crypto Planet with the Best Crypto Coins')
    ...
    <div class="main-content">
            ...
            <div class="container">
                <div class="row h-100">
                    <div class="col-lg-5 col-md-12 align-self-center">
                        ...
                        <a class="button mt-4" href="strategy">
        ...
        <section class="overview-block-ptb">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-sm-12 iq-r-mt-40 wow fadeInRight" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight; text-align : center;"> 
                        <img class="img-fluid"  src="images/home/tokens graphs.svg" alt="Crypto Tokens" width="100%">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="iq-clients">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInLeft;">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 wow fadeInRight" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight;">
                        <div class="iq-clients-blog iq-mtb-15 rounded">
                            <div class="d-flex align-items-center flex-wrap response_pad">
