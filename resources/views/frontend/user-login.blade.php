@section('title', 'Planet Syari | User Login')
...
<div class="container">
    <div class="row">
        ...
        <h2 class="text-center mt-5">Login Account</h2>
    </div>
            ...
            <div class="">
                <div class="card-body">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <button type="submit" class="button button-icon bt-lg iq-mr-15 mb-2">Login</button>
                    </form>
                </div>
            </div>
        </div>
