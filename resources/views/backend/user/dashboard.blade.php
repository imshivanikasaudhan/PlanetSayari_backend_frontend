        ...
        <div class="col-lg-12">
          <div class="card overflow-hidden">
            <div class="card-body p-4">
              <h5 class="card-title mb-9 fw-semibold">Total Deal Pending</h5>
        ...
        <div class="card">
          <div class="card-body">
            <div class="row alig n-items-start">
              <div class="col-8">
                <h5 class="card-title mb-9 fw-semibold"> Total contact Query </h5>
  ...
  <div class="row">
    <div class="container">
      ...
      <div class="py-6 px-6 text-center">
        <p class="mb-0 fs-4">Design and Developed by <a href="https://www.avtarspace.com" target="_blank">Avtar Space Technology</a></p>
      </div>
