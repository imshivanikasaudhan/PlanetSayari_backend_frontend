                        ...
                        <div class="col-lg-12 col-md-6 d-flex flex-column align-items-center text-center">
                            @if (Auth::user()->image == null)
                                <img src="backend\assets\images\profile\user-1.jpg"
                                    alt="@if (Auth::user()->user_type == 0) Broker @else Investor @endif" width="150"
        ...
        <div class="row">
            <div class="container">
                                          ...
                                          <h6 class="fw-semibold mb-1">{{ $Status->id }}</h6>
                                                        ...
                                                        @if (Auth::user()->user_type == 1)
                                                            <td class="border-bottom-0">
                                                                <h6 class="fw-semibold mb-0 fs-4">
                                                                    ${{ $Status->inst_amt }} M</h6>
                                                            </td>
                                                        @else
                                                            <td class="border-bottom-0">
                                                                <h6 class="fw-semibold mb-0 fs-4">
                                                                    {{ $Status->broker_per }} </h6>
                                                            </td>
                                                        @endif
                                                        <td class="border-bottom-0">
                                                        ...
                                                        <td class="border-bottom-0">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="backend/assets/images/{{ $Status->document }}"
                                                                    target="_blank"> <span
                                                        ...
                                                        <td class="border-bottom-0">
                                                            @if ($Status->status == 'Pending')
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <span
                                                                        class="badge bg-warning rounded-3 fw-semibold">Pending</span>
                                                                </div>
                                                            @elseif($Status->status == 'Processing')
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <span
                                                                        class="badge bg-info rounded-3 fw-semibold">processing</span>
                                                                </div>
                                                            @else
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <span
                                                                        class="badge bg-success rounded-3 fw-semibold">Verified</span>
                                                                </div>
                                                            @endif
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{ url('delete/' . $Status->id) }}"
                                                                    id="id" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
                ...
                <div class="py-6 px-6 text-center">
                    <p class="mb-0 fs-4">Design and Developed by <a href="https://www.avtarspace.com"
                            target="_blank">Avtar Space Technology</a></p>
                </div>
