      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="request-deal" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="Inputusername" class="form-label">Full Name<span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
              <label for="Inputusernumber" class="form-label">Contact No.<span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
              <label for="Inputuserskyp" class="form-label">Skype ID<span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
              <label for="InputContact_Message" class="form-label">Full Address<span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
              <label for="Inputusercountry" class="form-label">Country<span class="text-danger">*</span></label>
            ...
            @else
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Broker Percentage<span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
              <label for="Profile-pic" class="form-label">Other Documents<span class="text-danger">*</span></label>
